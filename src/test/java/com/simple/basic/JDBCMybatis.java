...
//		
//		ScoreVO vo = testMapper.getOne(9);
...
//		Map<String, Object> map = testMapper.selectMap(10);
//		System.out.println(map.toString());
//		
//	}
	
	//select - map타입의 반환: map타입을 사용하는 것은 부득이한 경우에만 사용합니다.
//	@Test
